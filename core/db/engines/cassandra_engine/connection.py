from core.db.engines.cassandra_engine.utils import get_cassandra_connections
...
class CassandraConnection(object):
    ...
    def register(self):
        try:
            ...
            try:
                session = connection.get_session(connection=self.alias)
                if session and self.keyspace:
