...
urlpatterns = [
    ...
    path('auth/google/google/login/', GoogleSpaceOAuthLoginView.as_view(), name='space_google_login'),
    path('auth/google/google/callback/', GoogleSpaceOAuthCallbackView.as_view(), name='space_google_callback'),
