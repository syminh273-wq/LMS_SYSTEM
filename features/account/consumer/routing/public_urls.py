...
urlpatterns = [
    ...
    path('auth/google/google/login/', GoogleConsumerOAuthLoginView.as_view(), name='consumer_google_login'),
    path('auth/google/google/callback/', GoogleConsumerOAuthCallbackView.as_view(), name='consumer_google_callback'),
