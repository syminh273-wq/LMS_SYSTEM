...
class ClassroomAIViewSet(UserScopeMixin, ViewSet):
    """AI Q&A endpoints for the teacher (Space) classroom view. Split out of ClassroomViewSet."""
...
class ConsumerClassroomAIViewSet(UserScopeMixin, ViewSet):
